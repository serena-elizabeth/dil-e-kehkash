      ...
      <motion.div variants={stagger} initial="hidden" animate="show" className="flex flex-col gap-10">
        ...
        <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center sm:items-start gap-8">
          <div className="relative flex-shrink-0">
            ...
            <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-gold rounded-full" />
          </div>

          <div className="text-center sm:text-left">
            <span className="font-sans text-xs tracking-widest uppercase text-gold/60 block mb-2">The Voice Behind</span>
            <h1 className="font-serif text-4xl text-white mb-3">Dil-e-Kehkash</h1>
        ...
        <motion.div variants={fadeUp} className="flex flex-col gap-4">
          ...
          <p className="font-sans text-sm text-white/60 leading-relaxed">
            Dil-e-Kehkash — meaning <em className="text-white/80">"the heart that pulls like a galaxy"</em> — is a personal anthology where creativity meets vulnerability. It is not a portfolio. It is a confession, a celebration, a record of everything that has ever moved this soul.
          </p>
          <p className="font-sans text-sm text-white/60 leading-relaxed">
          ...
          <div className="flex gap-4">
            {[
              ...
              <a
                ...
                href={href}
                aria-label={label}
                className="p-3 glass-card rounded-sm text-white/40 hover:text-gold transition-colors duration-200"
